...
from htof.parse import HipparcosOriginalData, HipparcosRereductionJavaTool, HipparcosRereductionCDBook
...
class Astrometry(object):
    parsers = {'gaiadr2': GaiaDR2, 'gaia': GaiaData, 'hip21': HipparcosRereductionJavaTool,
               'hip1': HipparcosOriginalData, 'hip2': HipparcosRereductionCDBook}
